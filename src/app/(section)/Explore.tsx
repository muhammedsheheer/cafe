  ...
  return (
    <section className="h-full w-full bg-[#445AA8] px-4 pb-12 pt-12 md:px-[60px] md:pt-20 2xl:px-[100px]">
      <div className="flex w-full flex-col gap-6 md:gap-12">
        <h1 className="text-center font-road_rage text-4xl font-[700] uppercase tracking-[6px] text-[#fff] md:text-5xl">
          EXPLORE CAFE{" "}
        </h1>
        <div className="flex w-full flex-col gap-6 md:flex-row md:gap-8">
          <div className="flex w-full flex-col items-center justify-center gap-4 md:w-[33%]">
            ...
            />
            <h5 className="text-center font-poppins text-lg font-[700] uppercase tracking-[2.8px] text-[#fff] md:text-xl">
              breakfast
            </h5>
          </div>
          <div className="flex w-full flex-col items-center justify-center gap-4 md:w-[33%]">
